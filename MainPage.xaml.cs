...
namespace Final_DBP
{
    public partial class MainPage : ContentPage
    {
        ...
        private async void OnButtonClicked(System.Object sender, System.EventArgs e)
        {
            ...
            await Application.Current.MainPage.Navigation.PushModalAsync(new Page1(name, dateofBirth, occupation, phone, email, nationality, Level, Languages, Aptitudes, Skills, profile), true);
        }
